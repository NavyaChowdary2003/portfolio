...
const About = () => {
    let render = true
    let array = [
        'Hello! Im Navya Chowdary, a dedicated and passionate web developer with  dynamic and responsive websites and web applications. My journey in web development started Socialtek.in with internship.',
