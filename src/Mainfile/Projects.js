//Using callback function to get links
...
const Projects = () => {
    ...
    const links = [
        {
            url:'https://github.com/NavyaChowdary2003/E-com-React.git',
